...
const math_create_file_1 = require("./math_create_file");
// 创建 MCP 服务器
const server = new mcp_js_1.McpServer({
    ...
    instructions: "本 MCP 服务专为 MathWallet Android 项目开发过程设计，提供项目组件的自动化创建与代码生成能力。服务功能和规则如下：\n" +
        "\n" +
        "【服务目标】\n" +
...
// 创建 activity 工具
const createActivity = (0, math_create_file_1.getCreateActivityTool)();
server.tool(createActivity.name, createActivity.description, {}, createActivity.handler);
async function init() { }
async function main() {
