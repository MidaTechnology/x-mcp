...
const server = new mcp_js_1.McpServer({
    ...
    instructions: "获取城市的经纬度信息，和当天的温度和天气信息。使用场景包括但不限于：\n" +
...
// 工具：输入城市名称 -> 输出天气
server.registerTool("get_weather_by_city", {
    description: "获取中国一座城市的天气信息，比如'北京'、'上海'、'广州'、'深圳'等，返回当天的天气信息。",
    title: "获取城市天气信息",
    inputSchema: {
        city: zod_1.z
            .string()
...
//# sourceMappingURL=city_weather.js.map