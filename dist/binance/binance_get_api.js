...
exports.fetchBinanceTrades = fetchBinanceTrades;
exports.binanceDepth = binanceDepth;
exports.ping = ping;
exports.serverTime = serverTime;
exports.exchangeInfo = exchangeInfo;
exports.orderBook = orderBook;
exports.recentTrades = recentTrades;
exports.historicalTrades = historicalTrades;
exports.aggTrades = aggTrades;
exports.klines = klines;
exports.uiKlines = uiKlines;
exports.avgPrice = avgPrice;
exports.ticker24hr = ticker24hr;
exports.binanceTradingDay = binanceTradingDay;
exports.binanceTickerPrice = binanceTickerPrice;
exports.binanceBookTicker = binanceBookTicker;
exports.binanceTicker = binanceTicker;
const axios_1 = __importDefault(require("axios"));
const binance_config_1 = require("./binance_config");
async function axiosBinanceGet(path, params) {
    const baseUrl = (0, binance_config_1.getBaseUrl)();
 ...
 */
async function exchangeInfo(params) {
 ...
 */
async function orderBook(symbol, limit) {
    return axiosBinanceGet("/api/v3/depth", {
        symbol: symbol.toUpperCase(),
        ...(limit && { limit }),
    });
 ...
 */
async function recentTrades(symbol, limit) {
    return axiosBinanceGet("/api/v3/trades", {
        symbol: symbol.toUpperCase(),
        ...(limit && { limit }),
    });
 ...
 */
async function historicalTrades(symbol, limit, fromId) {
 ...
 */
async function aggTrades(symbol, opts) {
 ...
 */
async function klines(symbol, interval, opts) {
 ...
 */
async function uiKlines(symbol, interval, opts) {
 ...
 * 24hr价格变动情况
 */
async function ticker24hr(symbol) {
 ...
 */
async function binanceTradingDay(symbol) {
 ...
 */
async function binanceTickerPrice(symbol) {
 ...
 * @param symbol 可选，交易对，例如 "BTCUSDT"，不传返回所有交易对
 */
async function binanceBookTicker(symbol) {
 ...
 */
async function binanceTicker(symbol, symbols, windowSize, type) {
    const params = {};
    if (symbol)
...
//# sourceMappingURL=binance_get_api.js.map